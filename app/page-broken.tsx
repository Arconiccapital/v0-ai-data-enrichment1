    ...
    <div className="min-h-screen bg-white">
      {hasData ? (
        <div className="flex h-screen">
          ...
          {/* Main Content */}
          <div className={`flex-1 flex ${showAnalysis ? 'flex-row' : 'flex-col'} bg-background`}>
            <div className={`${showAnalysis ? 'flex-1' : 'w-full'} flex flex-col`}>
              {/* Top Toolbar */}
              <div className="bg-card border-b border-border px-6 py-3 shadow-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button 
                    size="sm"
                    className="bg-blue-600 hover:bg-blue-700 text-white font-sans shadow-sm"
